...
// Fetch all Mini Projects
try {
    $query = "SELECT subject, file_name FROM mini_projects ORDER BY subject ASC";
    $result = $conn->query($query);
    if (!$result) {
        throw new Exception("Failed to fetch mini projects.");
    }

    $upload_directory = "Uploads/mini_projects"; // Directory where mini projects are stored
    ...
    $error_message = "An error occurred while fetching mini projects. Please try again later.";
    $projects = [];
}
?>
...
<head>
    ...
    <meta name="description" content="View mini projects on AKTU Rankers, curated for B.Tech, M.Tech, and BCA students.">
    <meta name="keywords" content="AKTU Rankers, mini projects, B.Tech mini projects, M.Tech mini projects, BCA mini projects">
    <meta name="author" content="AKTU Rankers Team">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="Mini Projects - AKTU Rankers">
    <meta property="og:description" content="Access curated mini projects for AKTU students.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://yourdomain.com/mini_projects.php">
    <meta property="og:image" content="http://yourdomain.com/assets/og-image.jpg">
    <title>Mini Projects - AKTU Rankers</title>
    <link rel="canonical" href="http://yourdomain.com/mini_projects.php" />
                ...
                <div class="project-list">
                    <?php foreach ($projects as $project): ?>
                        <div class="project-item">
                            <span class="project-subject"><?php echo htmlspecialchars($project['subject']); ?></span>
                            <div class="project-actions">
                                <button class="btn btn-view" onclick="openViewer('<?php echo htmlspecialchars($upload_directory . '/' . $project['file_name']); ?>')">View</button>
                                <a href="<?php echo htmlspecialchars($upload_directory . '/' . $project['file_name']); ?>" class="btn btn-download" download>Download</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
            <?php else: ?>
                <p class="no-content">No mini projects available.</p>
            <?php endif; ?>
        </section>
    </main>
