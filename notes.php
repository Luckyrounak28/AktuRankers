...
// Fetch all notes semester-wise
try {
    $query = "SELECT semester, subject, file_name FROM notes ORDER BY semester ASC";
    $result = $conn->query($query);
    if (!$result) {
        throw new Exception("Failed to fetch notes.");
    }

    $upload_directory = "Uploads/notes"; // Directory where notes are stored

    // Grouping notes by semester
    $notes_by_semester = [];
    while ($row = $result->fetch_assoc()) {
        $notes_by_semester[$row['semester']][] = $row;
    }
} catch (Exception $e) {
    $error_message = "An error occurred while fetching notes. Please try again later.";
    $notes_by_semester = [];
}
?>
...
<head>
    ...
    <meta name="description" content="View semester-wise notes on AKTU Rankers, curated for B.Tech, M.Tech, and BCA students to excel in their studies.">
    <meta name="keywords" content="AKTU Rankers, notes, B.Tech notes, M.Tech notes, BCA notes, semester notes">
    <meta name="author" content="AKTU Rankers Team">
    <meta name="robots" content="index, follow">
    <meta property="og:title" content="View Notes - AKTU Rankers">
    <meta property="og:description" content="Access high-quality, semester-wise notes tailored for AKTU students.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://yourdomain.com/notes.php">
    <meta property="og:image" content="http://yourdomain.com/assets/og-image.jpg">
    <title>View Notes - AKTU Rankers</title>
    <link rel="canonical" href="http://yourdomain.com/notes.php" />
...
<body>
    ...
    <main>
        <section class="notes-section">
            <h2>Semester-Wise Notes</h2>
            <?php if (isset($error_message)): ?>
                <p class="error-message"><?php echo htmlspecialchars($error_message); ?></p>
            <?php elseif (!empty($notes_by_semester)): ?>
                <div class="accordion">
                    <?php foreach ($notes_by_semester as $semester => $notes): ?>
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <?php foreach ($notes as $note): ?>
                                    <div class="note-item">
                                        <span class="note-subject"><?php echo htmlspecialchars($note['subject']); ?></span>
            ...
            <?php else: ?>
                <p class="no-content">No notes available.</p>
            <?php endif; ?>
        </section>
    </main>
